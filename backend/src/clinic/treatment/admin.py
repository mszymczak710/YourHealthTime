...
class VisitAdminConfig(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        """
        Nadpisanie metody get_queryset w celu dodania adnotacji z pełnymi imionami i nazwiskami lekarza oraz pacjenta.

        Wzbogacenie zapytania bazowego o adnotacje z pełnym imieniem i nazwiskiem lekarza oraz pacjenta, skonstruowane przez konkatenację imienia i nazwiska. Adnotacje te wykorzystywane są do czytelniejszego wyświetlania rekordów wizyt w panelu administracyjnym.
        """
