...
import { FormComponentBase } from '@shared/shared-form/form-common/misc';
import { FormField, FormFieldAutocompleteData, FormFieldTypes, FormFields } from '@shared/shared-form/form-common/types';
...
export class DoctorDashboardComponent extends FormComponentBase implements OnInit {
  ...
  private initForm(): void {
    ...
    const specializationsArray = new UntypedFormArray([], { validators: Validators.required });
    this.form.addControl('specializations', specializationsArray);
  }
  ...
  private resetForm(): void {
    ...
    this.formListComponent.addRowsToFormArray(this.doctor.specializations);
    this.formArray.setValue(this.doctor.specializations);
