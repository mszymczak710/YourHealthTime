...
import { DateFieldComponentBase, StringsLoader } from '@shared/shared-form/form-common/misc';
import { DateSuffixes, DateType } from '@shared/shared-form/form-common/types';

export interface DateRangeFieldComponent extends StringsLoader {}

@Component({
  selector: 'wvw-date-range-field',
  standalone: true,
