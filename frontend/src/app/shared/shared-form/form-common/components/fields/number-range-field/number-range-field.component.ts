...
import { NumberFieldComponentBase, StringsLoader } from '@shared/shared-form/form-common/misc';
import { NumberRangeType } from '@shared/shared-form/form-common/types';

export interface NumberRangeFieldComponent extends StringsLoader {}

@Component({
  selector: 'wvw-number-range-field',
  standalone: true,
